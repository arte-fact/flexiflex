...
import com.m2i.flexiflex.controllers.AuthController;
...
@ActiveProfiles("test")
public class AuthControllerTest extends BaseItTest {
    ...
    public void userCannotLoginWithBadPassword() {
        ...
        // WHEN
        ResponseEntity result = authController.login(testUserMail, testUserPassword);
        // THEN
